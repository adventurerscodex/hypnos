...
var _Hypnos = function _Hypnos(credentials, schema, cacheConfig) {
    ...
    this.action = function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref2) {
            var keys = _ref2.keys,
                ...
                _ref2$ttl = _ref2.ttl,
                ttl = _ref2$ttl === undefined ? null : _ref2$ttl;
    ...
    this.list = function () {
        var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(model) {
            ...
            var ttl = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : null;
            var keys;
                ...
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            ...
                            _context2.next = 3;
                            return _this.action({ keys: keys, params: params, raw: raw, model: model, many: true, useCache: useCache, flushDepsCache: flushDepsCache, ttl: ttl });
                ...
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            ...
                            _context3.next = 3;
                            return _this.action({ keys: keys, params: params, raw: raw, model: model, many: false, useCache: useCache, flushDepsCache: flushDepsCache, ttl: ttl });
