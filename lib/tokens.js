...
var InstanceToken = exports.InstanceToken = function InstanceToken(model, instance) {
    ...
    this.create = function () {
        ...
        var cleanedParams = _this.instance.clean(keys, params);
        var schemaValues = _this.instance.toSchemaValues(cleanedParams);
        return _this.client.action(keys, schemaValues, false, _this.model, false);
    };
    ...
    this.save = function () {
        ...
        var cleanedParams = _this.instance.clean(keys, params);
        var schemaValues = _this.instance.toSchemaValues(cleanedParams);
        return _this.client.action(keys, schemaValues, raw, _this.model, false);
    };
    ...
    this.delete = function () {
        ...
        var cleanedParams = _this.instance.clean(keys, params);
        var schemaValues = _this.instance.toSchemaValues(cleanedParams);
        return _this.client.action(keys, schemaValues, true, _this.model, false);
    };
