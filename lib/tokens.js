...
var InstanceToken = exports.InstanceToken = function InstanceToken(model, instance) {
    ...
    this.create = function () {
        ...
        return _this.client.action(keys, cleanedParams, false, _this.model, false);
    };
    ...
    this.save = function () {
        ...
        var cleanedParams = _this.instance.clean(keys, params);
        return _this.client.action(keys, cleanedParams, raw, _this.model, false);
    };
    ...
    this.delete = function () {
        ...
        var params = _this.instance.exportValues();
        var cleanedParams = _this.instance.clean(keys, params);
        return _this.client.action(keys, cleanedParams, true, _this.model, false);
    };
